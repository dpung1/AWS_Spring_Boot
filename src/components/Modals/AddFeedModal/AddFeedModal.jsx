...
function SelectFeedImg({ setPage, setFiles }) {
    ...
    return (
        <div css={S.SSelectFeedImgContainer}>
            ...
            <h1 css={S.SFeedImgContainerText}>사진 및 동영상을 추가하여 새 게시물을 만들어보세요.</h1>
            <button css={S.SFeedImgContainerButton} onClick={handleSelectImg}>기기에서 선택</button>
            <input css={S.SFileInput} type='file' name='file'
            multiple={true}
...
function FeedDetaile({ isShow, setContent }) {
    ...
    return (
        <div css={S.SFeedDetaileContainer(isShow)}>
            ...
            <textarea css={S.SFeedContent} name="content" 
        ...
        switch(page) {
            ...
            case 2:
                setBodyComponent(<>
                    ...
                    <FeedDetaile isShow={isShowFeedDetail} setContent={setContent}/>
                </>)
                setTitle("미리보기")
                setIsShowFeedDetail(false)
